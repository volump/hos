...
export function getOpenidByName(username) {
  return request({
    url: '/power/account/infoByname',
    method: 'get',
    params: { username }
  })
}
...
//8、根据医生id将openid添加绑定到数据库
export function post_doc_openid(username, openid) {
  return request({
    url: '/power/account/openidmodify',
    method: 'get',
