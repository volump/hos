...
import com.training.hospital.common.security.AccountDetails;
import com.training.hospital.common.security.JwtTokenUtil;
...
import com.training.hospital.entity.*;
import com.training.hospital.mapper.PowerAccountMapper;
import com.training.hospital.mapper.PowerAccountRoleRelationMapper;
import com.training.hospital.mapper.dao.PowerAccountRoleRelationDao;
...
public class PowerAccountServiceImpl implements IPowerAccountService {
     ...
     */
    @Override
    public Optional<PowerAccount> getByopenid(String openid) {
    ...
    public boolean registerUser(UserRegisterParam param) {
        ...
        account.setStatus(1);
        account.setOpenid(param.getOpenid());
     ...
     */
    @Override
    public Optional<String> loginByopenid(String name) {
